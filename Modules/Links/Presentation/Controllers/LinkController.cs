...
public class LinkController : ControllerBase
{
    ...
    {
        var result = await _updateLinkUseCase.UpdateAsync(GetUserId(), linkId, dto);
        return Ok(result);
    }
    ...
    {
        var result = await _deleteLinkUseCase.DeleteAsync(GetUserId(), linkId);
        return Ok(result);
    }
    ...
    {
        var result = await _getAllLinksUseCase.GetAllAsync(GetUserId(), query);
        return Ok(result);
    }
    ...
    {
        var result = await _getLinkByIdUseCase.GetByIdAsync(GetUserId(), linkId);
        return Ok(result);
    }
}