...
public class UpdateCategoryUseCase
{
    ...
    {
        var category = await _categoryRepository.GetFirstOrDefaultCategoriesAsync(c => c.CategoryId == categoryId && c.UserId == userId) ?? throw new NotFoundException("Category not found");

        var exists = await _categoryRepository.CategoryExistsAsync(c => c.UserId == userId && c.Name == dto.Name && c.CategoryId != categoryId);
        ...
        await _categoryRepository.SaveCategoryChanges();
